...
#To print the letter Q using '*' symbol
...
for row in range(8):
    for col in range (6):
        if row in {1,2,3} and col in {0,4}:
            print('*',end = ' ')
...
#To print the letter S using '*' symbol
...
#To print the letter U using '*' symbol
...
#To print the letter V using '*' symbol
...
#To print the letter W using '*' symbol
...
#To print the letter X using '*' symbol
...
#To print the letter Y using '*' symbol
...
#To print the letter Z using '*' symbol
...
for row in range(7):
    for col in range (7):
        if row in {0,6} and col in {0,2,4,6}:
            print('*',end = '')
